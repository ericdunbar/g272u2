 ...
 * @param <Node>
 */
public class BinaryTreeOfficial<Node> {
	 ...
	 */
	public BinaryTreeOfficial(Node sampleNode, Node nil) {
	 ...
	 * to create a new node in newNode()
	 */
	public BinaryTreeOfficial(Node sampleNode) {
		this.sampleNode = sampleNode;
	}
	...
	public static void main(String[] args){
		Node a = new Node();
		BinaryTreeOfficial<Node> bt = new BinaryTreeOfficial<>(a);
