...
/**
 * From ODS. From sample code. An ugly little class for allocating objects and
 * arrays of generic type T. This is needed to work around limitations of Java
 * generics.
 */
public class Factory<T> {
	...
	/**
	 * Constructor - creates a factory for creating objects and arrays of type
	 * t(=T)
	 * 
	 * @param t0
	 */
